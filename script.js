...
const visibleElements = ".title, .subtitleTop, .subtitleBottom, .basicText, .link, .pcPart, .welcome, .see, #tv, #videoButtonsContainer, .videoGame, .soundtrack, .soundtrackImage";
